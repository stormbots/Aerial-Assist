...
public class Robot extends IterativeRobot {
    ...
    private void updateLCD(){
           ...
           lcd.println(Line.kUser1, 1, "Motor Temperatures:" + " ");
           lcd.println(Line.kUser2, 1, "Range 1 = " + RobotMap.rangeFinder8.getAverageValue() + " ");
           lcd.println(Line.kUser3, 1, "Range 2 = " + RobotMap.rangeFinder9.getAverageValue() + " ");
           lcd.println(Line.kUser4, 1, "Auto Aim = " + OI.autoAimEnable + " ");
           lcd.println(Line.kUser5, 1, "Controls Enabled= " + OI.stickEngaged + " ");
           lcd.println(Line.kUser6, 1, "Shooting State: " + RobotMap.shootPrint);
           lcd.updateLCD();
    }
}
