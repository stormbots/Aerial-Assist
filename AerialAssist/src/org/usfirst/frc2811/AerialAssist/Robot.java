...
public class Robot extends IterativeRobot {
    ...
    private static CommandGroup firelong;
    ...
    public void teleopPeriodic() {
        ...
        //System.out.println("No errors thus far...");
           ...
           DriverStationLCD.getInstance().println(Line.kUser4, 1, "Motor 3 = " + RobotMap.temp3.getValue() + " ");
           DriverStationLCD.getInstance().println(Line.kUser5, 1, "Ranges: "+ RobotMap.range.getAverageValue() + " " + RobotMap.range2.getAverageValue());
           DriverStationLCD.getInstance().updateLCD();
        
        if (RobotMap.rangeValue >= RobotMap.range2Value){
            RobotMap.largerValue = RobotMap.rangeValue;
        }else{
            RobotMap.largerValue = RobotMap.range2Value;
        }
