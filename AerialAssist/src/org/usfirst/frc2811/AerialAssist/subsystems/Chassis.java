...
public class Chassis extends Subsystem {
    ...
    public void manualControl(double a, double b){
       if (Math.abs(a-RegulatedSpeed)> 0.1){
                RegulatedSpeed = ((Math.abs(RegulatedSpeed)> Math.abs(a) && (RegulatedSpeed>0) == (a>0)) ? a : Math.abs(a-RegulatedSpeed)>0.1 ? RegulatedSpeed+((a-RegulatedSpeed>0) ? 0.1 : -0.1): a);
                robotDrive41.arcadeDrive(RegulatedSpeed,b);
    ...
    public void manualShift(boolean a){
        ShiftDirection = a;
        gearShifter.set(ShiftDirection);
    }
