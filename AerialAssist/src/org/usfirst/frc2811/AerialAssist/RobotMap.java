...
public class RobotMap {
    ...
    range2 = new AnalogChannel(3);
    temp1 = new AnalogChannel(5);
    temp3 = new AnalogChannel(7);
    
    rangeValue = range.getAverageValue();
    range2Value = range2.getAverageValue();
     
    armed = false;
    
    
    motor1 = new Jaguar(1,1);
    motor2 = new Jaguar(1,2);
    motor3 = new Victor(1,3);
    motor4 = new Victor(1,4);
    motor5 = new Victor(1,5);
    motor6 = new Victor(1,6);
